...
INSERT INTO [dbo].[Config] ([SourcePlatform], [SourceLayer], [SourceFolder], [SourceSchema], [SourceItem], [SourceColumns], [SinkPlatform], [SinkLayer], [SinkFolder], [SinkSchema], [SinkItem], [IsActive]) 
VALUES ('ra-sqldb', NULL, NULL, 'dbo', 'Table1','rowId,Value','adl1','raw','folder1',NULL,'Table1',1)
INSERT INTO [dbo].[Config] ([SourcePlatform], [SourceLayer], [SourceFolder], [SourceSchema], [SourceItem], [SourceColumns], [SinkPlatform], [SinkLayer], [SinkFolder], [SinkSchema], [SinkItem], [IsActive]) 
VALUES ('ra-sqldb', NULL, NULL, 'dbo', 'Table2','rowId,Value','adl1','raw','folder1',NULL,'Table2',1)
INSERT INTO [dbo].[Config] ([SourcePlatform], [SourceLayer], [SourceFolder], [SourceSchema], [SourceItem], [SourceColumns], [SinkPlatform], [SinkLayer], [SinkFolder], [SinkSchema], [SinkItem], [IsActive]) 
VALUES ('ra-sqldb', NULL, NULL, 'dbo', 'Table3','rowId,Value','adl1','raw','folder1',NULL,'Table3',1)
